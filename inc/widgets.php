...
class Twenty_Eleven_Ephemera_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct( 'widget_newtheme_ephemera', __( 'Twenty Eleven Ephemera', 'newtheme' ), array(
			'classname'   => 'widget_newtheme_ephemera',
			'description' => __( 'Use this widget to list your recent Aside, Status, Quote, and Link posts', 'newtheme' ),
	...
	function widget( $args, $instance ) {
		...
		$args['title'] = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Ephemera', 'newtheme' ) : $instance['title'], $instance, $this->id_base );
		...
		if ( $ephemera->have_posts() ) :
			...
			<?php while ( $ephemera->have_posts() ) : $ephemera->the_post(); ?>
				...
				<li class="widget-entry-title">
					<a href="<?php echo esc_url( newtheme_get_first_url() ); ?>" rel="bookmark"><?php the_title(); ?>&nbsp;<span>&rarr;</span></a>
					<span class="comments-link">
						<?php comments_popup_link( __( '0 <span class="reply">comments &rarr;</span>', 'newtheme' ), __( '1 <span class="reply">comment &rarr;</span>', 'newtheme' ), __( '% <span class="reply">comments &rarr;</span>', 'newtheme' ) ); ?>
					</span>
				</li>
