...
function newtheme_theme_options_help() {
	...
	$sidebar = '<p><strong>' . __( 'For more information:', 'newtheme' ) . '</strong></p>' .
		'<p>' . __( '<a href="https://codex.wordpress.org/Appearance_Theme_Options_Screen" target="_blank">Documentation on Theme Options</a>', 'newtheme' ) . '</p>' .
		'<p>' . __( '<a href="https://wordpress.org/support/" target="_blank">Support Forums</a>', 'newtheme' ) . '</p>';
 ...
 * @see newtheme_customize_register()
 *
 * @return void
 */
...
function newtheme_customize_preview_js() {
	wp_enqueue_script( 'newtheme-customizer', get_template_directory_uri() . '/inc/theme-customizer.js', array( 'customize-preview' ), '20150401', true );
}
